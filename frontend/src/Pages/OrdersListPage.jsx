                  ...
                  <th>
                    ...
                    <div>
                      <Filter
                        ...
                        onFilterSelect={(e) => handleFiltering(e, 1)}
                      />
                    </div>
                  </th>
                  <th>
                    ...
                    <div>
                      <Filter
                        whatToFilter={data
                          .map((order) => order.loadingAddress)
                          .filter((x, i, a) => a.indexOf(x) == i)}
                        onFilterSelect={(e) => handleFiltering(e, 2)}
                      />
                    </div>
                  </th>
                  <th>
                    ...
                    <div>
                      <Filter
                        whatToFilter={data
                          .map((order) => order.unloadingAddress)
                          .filter((x, i, a) => a.indexOf(x) == i)}
                        onFilterSelect={(e) => handleFiltering(e, 3)}
                      />
                    </div>
                  </th>
                  <th>
                    ...
                    <div>
                      <Filter
                        whatToFilter={["Finished", "Not finished"]}
                        onFilterSelect={(e) => handleFiltering(e, 4)}
                      />
                    </div>
                  </th>
                  <th>
                    ...
                    <div>
                      <Filter
                        whatToFilter={data
                          ...
                          .filter((x, i, a) => a.indexOf(x) == i)}
                        onFilterSelect={(e) => handleFiltering(e, 5)}
                      />
                    </div>
                  </th>
                  <th>
                    ...
                    <div>
                      <Filter
                        whatToFilter={data
                          .map((order) => order.goodsName)
                          .filter((x, i, a) => a.indexOf(x) == i)}
                        onFilterSelect={(e) => handleFiltering(e, 6)}
                      />
                    </div>
                  </th>
                  <th></th>
              ...
              <tbody>
                {filteredData.map((order) => (
                  <tr key={order.id}>
                    ...
                    <td>
                      {order.unloadingDate !== null
                        ? order.unloadingDate.split("T")[0]
                        : ""}
                    </td>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => {
                          window.location.href = `/admin/orders/update/${order.id}`;
                        }}
                      >
                        Edit
                      </button>
                    ...
                    <td>
                      <button
                        ...
                        onClick={(e) => handleClick(order.id)}
                      >
                        Delete
                      </button>
                    </td>
